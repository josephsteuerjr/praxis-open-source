...
- [`TEMPLATES.md`](TEMPLATES.md) — муляжи `*.example.md` вместо живой памяти, границы
  этой памяти числами (потолки, TTL, область видимости, права записи, откат) и роспись
  ожидаемо красных тестов зеркала;
